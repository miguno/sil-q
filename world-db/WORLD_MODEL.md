...
This document presents a comprehensive entity-relationship model for the Sil-Q
game world, synthesizing information from data files (`lib/edit/*.txt`) and
hardcoded behavior (`src/*.c`).
...
Represents all creature types in the game.
...
| method       | string | Attack method (RBM\_\* constant) |
| effect       | string | Attack effect (RBE\_\* constant) |
...
**Source:** `lib/pref/graf-new.prf`, `lib/pref/flvr-new.prf`
...
Based on this model, the SQLite schema should include:
